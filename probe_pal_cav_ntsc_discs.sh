...
# Output file
OUTPUT="pal-cav-ntsc-discs-frame-ranges.txt"
> "$OUTPUT"  # Clear the file

echo "========================================"
echo "PAL CAV NTSC Discs Frame Range Probe Script"
echo "========================================"
echo ""
...
while IFS= read -r filepath; do
    ...
    while true; do
        ...
        ld-decode --NTSC --start $probe_pos --length 1 "$filepath_clean" /tmp/pal_cav_ntsc_decode_$$ 2>&1 > /tmp/ld_output_$$_2.txt
