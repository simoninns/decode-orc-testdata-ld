#!/bin/bash
# Auto-generated stacking test decode commands
set -e

# Dragon's Lair - NTSC CAV - 53 frames at VBI 10000-10052
ldf_file="../../ld-decode-stacking/ntsc/cav/Dragons-Lair_DS1_Side1_VBI10000-10052.ldf"
temp_output="Dragons-Lair_DS1_temp"
ld-decode --NTSC --seek 10000 --length 53 --write-test-ldf "$ldf_file" /home/sdi/raid/library/Arcade/Dragons_Lair/Dragons-Lair_DS1_Side1_20191230_CAV_NTSC.ldf "$temp_output" && rm -f "$temp_output.tbc" "$temp_output.tbc.json" "$temp_output.efm" "$temp_output.pcm"

ldf_file="../../ld-decode-stacking/ntsc/cav/Dragons-Lair_DS2_Side1_VBI10000-10052.ldf"
temp_output="Dragons-Lair_DS2_temp"
ld-decode --NTSC --seek 10000 --length 53 --write-test-ldf "$ldf_file" /home/sdi/raid/library/Arcade/Dragons_Lair/Dragons-Lair_DS2_Side1_20191230_CAV_NTSC.ldf "$temp_output" && rm -f "$temp_output.tbc" "$temp_output.tbc.json" "$temp_output.efm" "$temp_output.pcm"

ldf_file="../../ld-decode-stacking/ntsc/cav/Dragons-Lair_DS4_Side1_VBI10000-10052.ldf"
temp_output="Dragons-Lair_DS4_temp"
ld-decode --NTSC --seek 10000 --length 53 --write-test-ldf "$ldf_file" /home/sdi/raid/library/Arcade/Dragons_Lair/Dragons-Lair_DS4_Side1_20191230_CAV_NTSC.ldf "$temp_output" && rm -f "$temp_output.tbc" "$temp_output.tbc.json" "$temp_output.efm" "$temp_output.pcm"


# The World the UN and You - PAL CAV - 35 frames at VBI 10000-10034
ldf_file="../../ld-decode-stacking/pal/cav/UN-You_Disc1_VBI10000-10034.ldf"
temp_output="UN-You_Disc1_temp"
ld-decode --PAL --seek 10000 --length 35 --write-test-ldf "$ldf_file" /home/sdi/raid/library/Interactive_Video/The_UN/The\ World\ the\ UN\ and\ You_CAV_PAL_Disc1_2019-09-15_18-27-44.ldf "$temp_output" && rm -f "$temp_output.tbc" "$temp_output.tbc.json" "$temp_output.efm" "$temp_output.pcm"

ldf_file="../../ld-decode-stacking/pal/cav/UN-You_Disc3_VBI10000-10034.ldf"
temp_output="UN-You_Disc3_temp"
ld-decode --PAL --seek 10000 --length 35 --write-test-ldf "$ldf_file" /home/sdi/raid/library/Interactive_Video/The_UN/The\ World\ the\ UN\ and\ You_CAV_PAL_Disc3_2019-09-15_19-36-50.ldf "$temp_output" && rm -f "$temp_output.tbc" "$temp_output.tbc.json" "$temp_output.efm" "$temp_output.pcm"

ldf_file="../../ld-decode-stacking/pal/cav/UN-You_Disc5_VBI10000-10034.ldf"
temp_output="UN-You_Disc5_temp"
ld-decode --PAL --seek 10000 --length 35 --write-test-ldf "$ldf_file" /home/sdi/raid/library/Interactive_Video/The_UN/The\ World\ the\ UN\ and\ You_CAV_PAL_Disc5_2019-09-15_20-56-00.ldf "$temp_output" && rm -f "$temp_output.tbc" "$temp_output.tbc.json" "$temp_output.efm" "$temp_output.pcm"

ldf_file="../../ld-decode-stacking/pal/cav/UN-You_Disc7_VBI10000-10034.ldf"
temp_output="UN-You_Disc7_temp"
ld-decode --PAL --seek 10000 --length 35 --write-test-ldf "$ldf_file" /home/sdi/raid/library/Interactive_Video/The_UN/The\ World\ the\ UN\ and\ You_CAV_PAL_Disc7_2019-09-15_21-59-24.ldf "$temp_output" && rm -f "$temp_output.tbc" "$temp_output.tbc.json" "$temp_output.efm" "$temp_output.pcm"


# Domesday NationalB_PP - PAL CLV - 35 frames at ~5:00.00 (frame 7500)
...
# British Garden Birds Side1 - PAL CAV - 35 frames at VBI 10000-10034
...
# British Garden Birds Side2 - PAL CAV - 35 frames at VBI 10000-10034
